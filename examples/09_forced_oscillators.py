...
\\parameter{{F0}}{{1.0}}{{N}}
\\parameter{{omega_d}}{{omega_d1:.3f}}{{rad/s}}
...
print("\n" + "="*60)
print("AT RESONANCE (ω_d = ω₀) - MAXIMUM AMPLITUDE!")
print("="*60)
...
\\parameter{{k}}{{10.0}}{{N/m}}
\\parameter{{F0}}{{1.0}}{{N}}
\\parameter{{omega_d}}{{omega_d2:.3f}}{{rad/s}}
...
\\parameter{{k}}{{10.0}}{{N/m}}
\\parameter{{F0}}{{1.0}}{{N}}
\\parameter{{omega_d}}{{omega_d3:.3f}}{{rad/s}}
...
axes[1, 0].set_title(f'At Resonance (ω_d = {omega_d2:.2f} rad/s) - LARGE AMPLITUDE!')
axes[1, 0].legend()
