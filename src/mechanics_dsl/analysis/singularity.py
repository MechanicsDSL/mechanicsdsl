...
class SingularityWarning:
    ...
    def __str__(self) -> str:
        return (f"[{self.severity.upper()}] {self.type.name}: {self.location}\n"
...
class SingularityDetector:
    ...
    def _check_division_singularities(
        self, expr: sp.Expr, name: str
    ) -> List[SingularityWarning]:
