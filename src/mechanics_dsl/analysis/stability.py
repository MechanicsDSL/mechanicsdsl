...
class StabilityAnalyzer:
    ...
    def find_fixed_points(
        self, equations: Dict[str, sp.Expr], variables: List[sp.Symbol]
    ) -> List[Dict]:
        """
    ...
    def analyze_stability(self, jacobian: sp.Matrix, fixed_point: Dict) -> Dict:
        """
    ...
    def estimate_lyapunov_exponent(
        self, trajectory: np.ndarray, dt: float, n_renorm: int = 100
    ) -> float:
        """
