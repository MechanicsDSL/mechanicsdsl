...
class DieselCycle:
    ...
    def __init__(self, compression_ratio: float, cutoff_ratio: float, gamma: float = 1.4):
        """
...
class PhaseTransition:
    ...
    def __init__(
        self, T_transition: float, P_transition: float, latent_heat: float, delta_V: float
    ):
        """
