...
class StabilityResult:
    ...
    def is_stable(self) -> bool:
        ...
        return self.stability_type in [
            StabilityType.STABLE,
            StabilityType.MARGINALLY_STABLE,
    ...
    def __repr__(self) -> str:
        return (
            f"StabilityResult(type={self.stability_type.value}, "
...
class StabilityAnalyzer:
    ...
    def _is_minimum(
        self, potential: sp.Expr, q_symbols: List[sp.Symbol], subs_dict: Dict[sp.Symbol, float]
    ) -> bool:
    ...
    def linearize_lagrangian(
        self, lagrangian: sp.Expr, coordinates: List[str], equilibrium: EquilibriumPoint
        ...
        eq_subs = {self.get_symbol(q): equilibrium.coordinates.get(q, 0.0) for q in coordinates}
    ...
    def analyze_stability(
        ...
        equilibrium: EquilibriumPoint,
        coordinates: List[str],
        damping_matrix: Optional[sp.Matrix] = None,
    ) -> StabilityResult:
        """
...
def analyze_stability(
    lagrangian: sp.Expr,
    coordinates: List[str],
    equilibrium_values: Optional[Dict[str, float]] = None,
) -> StabilityResult:
    """
