...
class RayleighDissipation:
    ...
    def add_damping(
        self, coordinate: str, coefficient: float, cross_coordinate: Optional[str] = None
    ) -> None:
        """
...
class DissipativeLagrangianMechanics:
    ...
    def add_driving_force(
        self, coordinate: str, amplitude: float, frequency: float, phase: float = 0.0
    ) -> None:
        """
