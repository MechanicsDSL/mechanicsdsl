...
class RigidBodyDynamics(PhysicsDomain):
    ...
    def set_inertia_symbolic(
        self, I1_sym: str = "I1", I2_sym: str = "I2", I3_sym: str = "I3"
    ) -> None:
        """
    ...
    def _rotational_kinetic_energy(self) -> sp.Expr:
        ...
        T = (
            sp.Rational(1, 2) * self._I1 * omega1**2
    ...
    def _quaternion_E_matrix(self) -> sp.Matrix:
        ...
        E = sp.Matrix([[-q1, q0, -q3, q2], [-q2, q3, q0, -q1], [-q3, -q2, q1, q0]])
    ...
    def angular_momentum_space_frame(self) -> sp.Matrix:
        ...
        L_body = sp.Matrix([self._I1 * omega1, self._I2 * omega2, self._I3 * omega3])
...
class SymmetricTop(RigidBodyDynamics):
    ...
    def __init__(self, name: str = "symmetric_top", I_perp: float = 1.0, I_axis: float = 0.5):
        super().__init__(name)
