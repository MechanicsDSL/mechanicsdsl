...
class BaumgarteStabilization:
    ...
    def velocity_level_constraint(self, constraint: sp.Expr, coordinates: List[str]) -> sp.Expr:
        """
    ...
    def acceleration_level_constraint(self, constraint: sp.Expr, coordinates: List[str]) -> sp.Expr:
        """
    ...
    def stabilized_constraint(self, constraint: sp.Expr, coordinates: List[str]) -> sp.Expr:
        """
    ...
    def compute_constraint_force(
        self, constraint: sp.Expr, lagrangian: sp.Expr, coordinates: List[str]
    ) -> Dict[str, sp.Expr]:
        """
