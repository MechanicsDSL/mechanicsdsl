...
class PerturbationExpander:
    ...
    def expand_hamiltonian(
        self, H0: sp.Expr, H1: sp.Expr, coordinates: List[str], order: int = 1
    ) -> PerturbationResult:
        """
        ...
        return PerturbationResult(order=order, unperturbed=H0, corrections=corrections)

    def _first_order_correction(self, H0: sp.Expr, H1: sp.Expr, coordinates: List[str]) -> sp.Expr:
    ...
    def _second_order_correction(self, H0: sp.Expr, H1: sp.Expr, coordinates: List[str]) -> sp.Expr:
    ...
    def lindstedt_poincare(
        ...
        return {"frequency": omega, "frequency_corrections": omega_corrections, "order": order}

    def average_over_fast_angle(self, expr: sp.Expr, angle: str) -> sp.Expr:
        """
    ...
    def separate_secular_periodic(
        self, solution: sp.Expr, time: sp.Symbol
...
class AveragingMethod:
    ...
    def average_system(self, rhs: sp.Expr, fast_var: str, period: sp.Expr) -> sp.Expr:
        """
    ...
    def action_angle_averaging(self, hamiltonian: sp.Expr, action: str, angle: str) -> sp.Expr:
        """
...
class MultiScaleAnalysis:
    ...
    def define_time_scales(self, t: sp.Symbol, epsilon: sp.Symbol) -> List[sp.Symbol]:
        """
    ...
    def expand_derivative(self, time_scales: List[sp.Symbol], epsilon: sp.Symbol) -> sp.Expr:
        """
    ...
    def remove_secular_terms(self, equations: List[sp.Expr], fast_time: sp.Symbol) -> List[sp.Expr]:
        """
...
def perturbation_expand(
    H0: sp.Expr, H1: sp.Expr, coordinates: List[str], order: int = 1
) -> PerturbationResult:
    """
