...
class VonMisesStress:
    ...
    def from_components(
        ...
        tau_xy: float, tau_yz: float, tau_xz: float
    ) -> float:
        """
...
class DeviatoricStress:
    ...
    @staticmethod
    def principal_deviatoric(sigma1: float, sigma2: float, sigma3: float) -> Tuple[float, float, float]:
        """
...
class EquivalentStrain:
    ...
    def from_tensor(cls, epsilon: np.ndarray) -> 'EquivalentStrain':
        ...
        return cls(
            ...
            deviatoric_magnitude=math.sqrt(2 * J2)
        )
...
class MohrsCircle2D:
    ...
    @classmethod
    def from_stress(
        cls, sigma_x: float, sigma_y: float, tau_xy: float
    ) -> 'MohrsCircle2D':
        """
...
class MohrsCircle3D:
    ...
    @classmethod
    def from_principal(
        cls, sigma1: float, sigma2: float, sigma3: float
    ) -> 'MohrsCircle3D':
        """
        ...
        return cls(
            ...
            circle_12=c12, circle_23=c23, circle_13=c13
        )
