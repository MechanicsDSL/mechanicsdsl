...
class WaveEquation:
    ...
    @staticmethod
    def plane_wave(x: float, t: float, A: float, k: float, 
                   omega: float, phi: float = 0) -> float:
        """
        Plane wave solution.
    ...
    @staticmethod
    def spherical_wave(r: float, t: float, A: float, k: float,
                       omega: float) -> float:
        """
    ...
    @staticmethod
    def standing_wave(x: float, t: float, A: float, k: float,
                      omega: float) -> float:
        """
...
class Resonance:
    ...
    @staticmethod
    def rectangular_cavity(Lx: float, Ly: float, Lz: float, 
                           c: float, modes: int = 5) -> List[Tuple[Tuple[int, int, int], float]]:
        """
...
class DopplerEffect:
    ...
    @staticmethod
    def frequency_shift(f0: float, c: float, v_source: float = 0, 
                        v_observer: float = 0) -> float:
        """
