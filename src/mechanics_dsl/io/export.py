...
class CSVExporter:
    ...
    @staticmethod
    def export_solution(solution: Dict[str, Any], filename: str, include_time: bool = True) -> bool:
        """
...
class JSONExporter:
    ...
    @staticmethod
    def export_solution(solution: Dict[str, Any], filename: str, compact: bool = False) -> bool:
        """
