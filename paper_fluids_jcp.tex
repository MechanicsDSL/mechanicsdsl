...
The compiler automatically selects appropriate kernels:

\begin{table}[htbp]
\centering
\caption{Automatic kernel assignment}
\label{tab:kernels}
\begin{tabular}{@{}lll@{}}
\toprule
Quantity & Kernel & Reason \\
\midrule
Density & Poly6 & Smooth, non-negative \\
Pressure force & Spiky gradient & Avoids clustering \\
Viscosity & Viscosity Laplacian & Correct diffusion \\
