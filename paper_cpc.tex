...
\author[inst1]{Noah Parsons\corref{cor1}}
\ead{contact@mechanicsdsl.org}
...
\begin{minipage}{0.48\textwidth}
\centering
% Placeholder for output figure
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}Phase Space Output\vspace{3cm}}}
\end{minipage}
...
\begin{itemize}
    \item \textbf{Repository}: \url{https://github.com/MechanicsDSL/mechanicsdsl}
    \item \textbf{Package}: \texttt{pip install mechanicsdsl-core}
    \item \textbf{Documentation}: \url{https://mechanicsdsl.readthedocs.io}
...
This project was developed as an independent research initiative. The author thanks the open-source community for maintaining SymPy, NumPy, SciPy, and Matplotlib.
