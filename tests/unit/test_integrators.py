...
class TestSymplecticIntegrators:
    ...
    def test_integrator_imports(self):
        ...
        from mechanics_dsl.solver.symplectic import (
            SymplecticIntegrator, StormerVerlet, Leapfrog,
            Yoshida4, Ruth3, McLachlan4, get_symplectic_integrator
        )
    ...
    def test_verlet_step(self):
        ...
        def grad_T(p): return p / 1.0
        def grad_V(q): return 4.0 * q
    ...
    def test_leapfrog_step(self):
        ...
        def grad_T(p): return p
        def grad_V(q): return q
...
class TestVariationalIntegrators:
    ...
    def test_integrator_imports(self):
        ...
        from mechanics_dsl.solver.variational import (
            VariationalIntegrator, MidpointVariational,
            TrapezoidalVariational, GalerkinVariational,
