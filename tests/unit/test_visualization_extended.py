...
def oscillator_solution():
    ...
    x = np.cos(t)
    x_dot = -np.sin(t)
    return {"success": True, "t": t, "y": np.array([x, x_dot]), "coordinates": ["x"]}
...
class TestAnimatorAnimatePendulum:
    ...
    def test_animate_pendulum(self, pendulum_solution):
        animator = Animator()
        result = animator.animate_pendulum(pendulum_solution, length=1.0, title="Pendulum")
    ...
    def test_animate_pendulum_custom_length(self, pendulum_solution):
        animator = Animator()
        result = animator.animate_pendulum(pendulum_solution, length=2.0, title="Pendulum")
...
class TestPlotterPlotTimeSeries:
    ...
    def test_plot_time_series(self, oscillator_solution):
        plotter = Plotter()
        result = plotter.plot_time_series(oscillator_solution, title="Time Series")
...
class TestPlotterPlotEnergy:
    ...
    def test_plot_energy(self, oscillator_solution):
        ...
        result = plotter.plot_energy(
            oscillator_solution, kinetic=kinetic, potential=potential, title="Energy"
        )
...
class TestPhaseSpaceVisualizerPlotPhasePortrait:
    ...
    def test_plot_phase_portrait(self, oscillator_solution):
        viz = PhaseSpaceVisualizer()
        result = viz.plot_phase_portrait(oscillator_solution, title="Phase Portrait")
...
class TestVisualizationEdgeCases:
    ...
    def test_zero_initial_conditions(self):
        ...
        solution = {"success": True, "t": t, "y": np.array([x, x_dot]), "coordinates": ["x"]}
