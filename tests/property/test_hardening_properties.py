...
small_angle = st.floats(min_value=-math.pi, max_value=math.pi, allow_nan=False, allow_infinity=False)
...
class TestSecurityProperties:
    ...
    def test_identifier_validation_never_crashes(self, s):
        ...
        from mechanics_dsl.security import validate_identifier, InputValidationError
    ...
    def test_string_validation_never_crashes(self, s):
        ...
        from mechanics_dsl.security import validate_string, InputValidationError
    ...
    def test_path_validation_never_crashes(self, s):
        ...
        from mechanics_dsl.security import validate_path, InputValidationError, PathTraversalError
    ...
    def test_dsl_validation_blocks_dangerous_patterns(self, s):
        ...
        from mechanics_dsl.security import validate_dsl_code, InjectionError, InputValidationError
