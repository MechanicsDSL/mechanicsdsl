...
class TestRelativisticInvariants:
    ...
    @given(
        v=st.floats(min_value=0.0, max_value=0.99, allow_nan=False)
    )
    @settings(max_examples=50)
    ...
    @given(
        v=st.floats(min_value=0.01, max_value=0.99, allow_nan=False)
    )
    @settings(max_examples=50)
...
class TestGeneralRelativity:
    ...
    @given(
        mass=st.floats(min_value=1e20, max_value=1e40, allow_nan=False)
    )
    ...
    @given(
        mass=st.floats(min_value=1e28, max_value=1e35, allow_nan=False)
    )
    @settings(max_examples=30)
