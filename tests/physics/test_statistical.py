...
class TestIdealGas:
    ...
    def test_ideal_gas_law(self):
        """PV = nRT."""
        from mechanics_dsl.domains.statistical import IdealGas, GAS_CONSTANT
    ...
    def test_internal_energy_monoatomic(self):
        ...
        from mechanics_dsl.domains.statistical import (
            IdealGas, BOLTZMANN_CONSTANT, AVOGADRO_NUMBER
        )
...
class TestQuantumStatistics:
    ...
    def test_bose_condensation(self):
        ...
        from mechanics_dsl.domains.statistical import BoseEinstein, BOLTZMANN_CONSTANT
