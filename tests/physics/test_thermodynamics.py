...
class TestOttoCycle:
    ...
    def test_otto_vs_carnot(self):
        ...
        from mechanics_dsl.domains.thermodynamics import CarnotEngine, OttoCycle
...
class TestVanDerWaalsGas:
    ...
    def test_ideal_gas_limit(self):
        ...
        from mechanics_dsl.domains.thermodynamics import R_GAS, VanDerWaalsGas
...
class TestPhaseTransition:
    ...
    def test_entropy_change(self):
        ...
        transition = PhaseTransition(
            T_transition=373.15, P_transition=101325, latent_heat=40650, delta_V=0.03
        )
...
class TestHeatCapacity:
    ...
    def test_debye_high_t_limit(self):
        """At T >> θ_D, C → 3nR."""
        from mechanics_dsl.domains.thermodynamics import R_GAS, HeatCapacity
