...
class TestTunnelingPhysics:
    ...
    def test_above_barrier_resonances(self):
        ...
        transmissions = [tunneling.rectangular_barrier(E, V0=2.0, width=5.0) for E in energies]
    ...
    def test_double_well_splitting(self):
        ...
        split_low = tunneling.double_well_splitting(
            omega=1.0, barrier_height=1.0, well_separation=2.0
        )
        split_high = tunneling.double_well_splitting(
            omega=1.0, barrier_height=5.0, well_separation=2.0
        )
