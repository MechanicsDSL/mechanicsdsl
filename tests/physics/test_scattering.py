...
class TestScatteringAnalyzer:
    ...
    def test_coulomb_scattering(self):
        ...
        result = analyzer.coulomb_scattering(energy=1.0, impact_parameter=1.0, k=1.0)
    ...
    def test_differential_cross_section(self):
        ...
        dcs = analyzer.rutherford_differential_cross_section(k=1.0, energy=1.0, theta=np.pi / 2)
