...
class TestOrbitClassification:
    ...
    def test_classify_bound_orbit(self):
        ...
        orbit_type = analyzer.classify_orbit(V, energy=-0.4, angular_momentum=1.0)
    ...
    def test_classify_unbound_orbit(self):
        ...
        orbit_type = analyzer.classify_orbit(V, energy=10.0, angular_momentum=0.1)
