...
class TestRocketParameters:
    ...
    def test_create_parameters(self):
        ...
        params = RocketParameters(
            initial_mass=1000.0, fuel_mass=800.0, exhaust_velocity=3000.0, mass_flow_rate=10.0
        )
...
class TestVariableMassSystem:
    ...
    def test_falling_chain(self):
        ...
        force = system.falling_chain(chain_length=2.0, linear_density=1.0, height=1.0, g=10.0)
