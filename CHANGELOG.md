...
MechanicsDSL has transitioned to **maintenance mode**.

### Added

- **MAINTENANCE.md** — Comprehensive maintenance mode documentation
- Maintenance mode notices in README.md and CONTRIBUTING.md

### Changed

- Project status changed to maintenance mode
- Version 1.5.x will receive security-only updates until June 2026
- New feature development is paused

### What This Means

- ✅ Security patches and critical bug fixes will continue
- ✅ Dependency compatibility updates will continue  
- ⏸️ New features are not being actively developed
- ❌ Major architectural changes are not planned
