...
unconstrained pathways. Every engine that returned an answer returned a correct one, and no engine
...
$1.6\times$ faster at every rung, while the symbolic compiler is about twice as
accurate. Neither difference is a capability boundary.
