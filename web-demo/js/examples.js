const EXAMPLES = {
    ...
    'rigid-body': { name: 'Rigid Body', code: `\\system{asymmetric_top}\n\n% Principal moments of inertia (kg·m^2)\n\\parameter{I1}{1.0}{kg*m^2}\n\\parameter{I2}{2.0}{kg*m^2}\n\\parameter{I3}{3.0}{kg*m^2}\n\n% Body-frame angular velocities (Euler's equations)\n\\defvar{omega1}{angular_vel_x}{rad/s}\n\\defvar{omega2}{angular_vel_y}{rad/s}\n\\defvar{omega3}{angular_vel_z}{rad/s}\n\n% Attitude as a unit quaternion (singularity-free)\n\\defvar{q}{quaternion}{1}\n\n\\equation{I1 \\dot{omega1} = (I2 - I3) omega2 omega3}\n\\equation{I2 \\dot{omega2} = (I3 - I1) omega3 omega1}\n\\equation{I3 \\dot{omega3} = (I1 - I2) omega1 omega2}\n\\equation{\\dot{q} = \\frac{1}{2} q \\otimes (0, omega1, omega2, omega3)}\n\n% Dzhanibekov effect: spin near intermediate axis\n\\initial{omega1=0.05, omega2=3.0, omega3=0}`, params: { type: 'rigid-body', wx: 0.05, wy: 3.0, wz: 0.0 } },
