...
A Proposed Pedagogical Framework Without Programming Prerequisites}
...
\begin{abstract}
We propose a pedagogical framework for teaching Lagrangian and Hamiltonian mechanics using MechanicsDSL, a domain-specific language that allows students to define physical systems using LaTeX-inspired notation without traditional programming. The system automatically derives equations of motion from Lagrangians and produces numerical simulations, enabling students to focus on physical principles rather than implementation details. We describe classroom activities suitable for undergraduate physics courses and discuss how this approach may reduce cognitive load compared to traditional programming-based methods. The framework is designed to accelerate understanding of variational mechanics, particularly for students without prior programming experience.
\end{abstract}
...
This pedagogical framework is designed around the following goals:
\begin{enumerate}
    \item Reduce cognitive load by eliminating programming syntax overhead
    \item Enable equivalent or better understanding of Lagrangian mechanics concepts
    \item Provide accessible entry points for students regardless of programming background
\end{enumerate}

We propose that future classroom studies could validate these goals through controlled experiments.
